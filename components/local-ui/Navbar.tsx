...
const Navbar = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full border-b border-white/[0.06] bg-background/90 shadow-[0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-md supports-[backdrop-filter]:bg-background/75">
